...
condition_map = {
    ...
    'kube-apiserver-slos': ' .Values.defaultRules.rules.kubeApiserverSlos',
    ...
    'kube-scheduler.rules': ' .Values.defaultRules.rules.kubeSchedulerRecording',
    'kube-state-metrics': ' .Values.defaultRules.rules.kubeStateMetrics',
    'kubelet.rules': ' .Values.defaultRules.rules.kubelet',
    ...
    'kubernetes-system-controller-manager': ' .Values.defaultRules.rules.kubeControllerManager',
    'kubernetes-system-scheduler': ' .Values.defaultRules.rules.kubeSchedulerAlerting',
