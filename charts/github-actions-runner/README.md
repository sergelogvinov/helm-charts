...
![Version: 2.12.2](https://img.shields.io/badge/Version-2.12.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.330.0](https://img.shields.io/badge/AppVersion-2.330.0-informational?style=flat-square)
...
| mirrors.image.tag | string | `"v2.1.12"` |  |
...
| registry.image.tag | string | `"v2.1.12"` |  |
