...
![Version: 2.22.0](https://img.shields.io/badge/Version-2.22.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.337.0](https://img.shields.io/badge/AppVersion-2.337.0-informational?style=flat-square)
...
| mirrors.image.tag | string | `"v2.1.20"` |  |
...
| registry.image.tag | string | `"v2.1.20"` |  |
