...
![Version: 2.20.1](https://img.shields.io/badge/Version-2.20.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.335.1](https://img.shields.io/badge/AppVersion-2.335.1-informational?style=flat-square)
...
| mirrors.image.tag | string | `"v2.1.18"` |  |
...
| registry.image.tag | string | `"v2.1.18"` |  |
